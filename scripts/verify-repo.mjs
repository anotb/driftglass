...
const required = [
  "README.md", "LICENSE", "SECURITY.md", "CONTRIBUTING.md", "ACKNOWLEDGEMENTS.md", "package-lock.json",
...
if (wrangler.browser !== undefined) throw new Error("The clean-account default deploy must not require a Browser binding");
...
if (staging.browser !== undefined) throw new Error("The public staging template must remain one-click compatible without a Browser binding");
if (
