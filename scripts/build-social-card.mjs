...
const lockupDataUrl = `data:image/png;base64,${(await readFile(join(repository, "public", "icons", "driftglass-lockup.png"))).toString("base64")}`;
...
function socialCardSvg() {
  return [
    ...
    `<image href="${lockupDataUrl}" x="68" y="52" width="165" height="40" preserveAspectRatio="xMinYMid meet"/>`,
    ...
    '<rect x="680" y="76" width="460" height="478" rx="16" fill="#ffffff" stroke="#d8d5cf" stroke-width="2"/>',
