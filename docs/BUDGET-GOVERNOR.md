...
These are application ceilings, not promises that every Cloudflare plan has identical allowances forever. The default source-checkout deployment omits Browser Rendering. Its rendered-browsing lane stays unused until the owner adds the binding after installation; the Free profile then keeps Driftglass below Cloudflare's daily Free allowance.
