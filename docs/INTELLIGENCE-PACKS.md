...
An Intelligence Pack is a portable setup for a research domain. It packages source coverage, standing questions, starter memory, evidence standards, scheduled routines, reasoning instructions, and a cost envelope in inspectable JSON.
