/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 71fa3c143672edc1e92bad1c0fa815f4)
...
interface __BaseEnv_Env {
	...
	APP_NAME: "Driftglass Staging" | "Driftglass";
	DEFAULT_TIMEZONE: "America/New_York";
	BRIEFING_LOCAL_HOUR: "7";
	MAX_DAILY_STORIES: "12";
	PUBLIC_BASE_URL: "";
	PUBLIC_INDEXING: "disabled" | "enabled";
	RAW_PUBLIC_RETENTION_DAYS: "30";
	INGEST_QUEUE_NAME: "driftglass-staging-ingest" | "driftglass-ingest";
	INGEST_DLQ_NAME: "driftglass-staging-ingest-dlq" | "driftglass-ingest-dlq";
	INGEST_QUARANTINE_NAME: "driftglass-staging-ingest-quarantine" | "driftglass-ingest-quarantine";
	DRIFTGLASS_SECRET: string;
	MISSION_COMPUTER: DurableObjectNamespace<import("./index").MissionComputer>;
	MISSION_WORKFLOW: Workflow<Parameters<import("./index").MissionSprintWorkflow['run']>[0]['payload']>;
	MEMORY_WORKFLOW: Workflow<Parameters<import("./index").MemoryGraphWorkflow['run']>[0]['payload']>;
	ROUTINE_WORKFLOW: Workflow<Parameters<import("./index").IntelligenceRoutineWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MissionComputer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "DEFAULT_TIMEZONE" | "BRIEFING_LOCAL_HOUR" | "MAX_DAILY_STORIES" | "PUBLIC_BASE_URL" | "PUBLIC_INDEXING" | "RAW_PUBLIC_RETENTION_DAYS" | "INGEST_QUEUE_NAME" | "INGEST_DLQ_NAME" | "INGEST_QUARANTINE_NAME" | "DRIFTGLASS_SECRET">> {}
}
